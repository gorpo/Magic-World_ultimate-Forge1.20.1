...
public final class MagicWorldStaticBackground {
    public static final ResourceLocation TITLE_BACKGROUND =
            new ResourceLocation(ExampleMod.MODID, "textures/gui/title/title_background_static.png");
    public static final ResourceLocation FULL_LOGO =
            new ResourceLocation(ExampleMod.MODID, "textures/gui/title/logo_full.png");
